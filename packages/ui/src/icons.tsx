...
export function IconMonitor({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPalette({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconInfo({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBarChart({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRepeat({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconListTodo({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconArrowUp({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconArrowDown({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconGripVertical({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconGithub({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCloud({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconImage({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
