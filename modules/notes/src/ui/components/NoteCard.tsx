...
export function NoteCard({
  ...
  return (
    <div
      ...
      className={`group relative rounded-panel border p-4.5 transition-all duration-200 cursor-pointer select-none flex flex-col justify-between hover-lift ${colorClass} ${
        isSelected
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 mb-2.5">
        <div className="flex items-center flex-wrap gap-1.5">
          ...
          {note.isPinned && (
            <span
              className="inline-flex items-center gap-1 text-[11px] font-bold text-warning bg-warning-soft px-2 py-0.5 rounded-full border border-warning/20 shadow-2xs"
              title="已置顶便签"
            >
              <span>📌</span>
              <span>置顶</span>
                  ...
                  <>
                    ...
                    {onDeletePermanent && (
                      <button
                        ...
                        className="px-3 py-1.5 text-left text-critical hover:bg-critical-soft/60 flex items-center gap-2 font-medium"
                      >
                        <IconTrash size={13} />
                        <span>彻底删除</span>
                      </button>
                  ...
                  <>
                    {onArchiveToggle && (
                      <button
                        ...
                        className="px-3 py-1.5 text-left hover:bg-surface-2 flex items-center gap-2 text-ink"
                      >
                    ...
                    {onExport && (
                      <button
                        ...
                        className="px-3 py-1.5 text-left hover:bg-surface-2 flex items-center gap-2 text-ink border-t border-line/60 mt-0.5 pt-1.5"
                      >
                        <span>📤</span>
                        <span>导出便签...</span>
                      </button>
