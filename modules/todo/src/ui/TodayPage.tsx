...
function TaskItemRow({
  ...
  return (
    <div
      className={`group flex items-center gap-3 rounded-control px-3 py-3 transition-all duration-150 ${
        isCurrent
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-5">
          {/* 今日执行度仪表盘卡片 */}
          <section className="relative overflow-hidden rounded-panel border border-slate-700/60 bg-gradient-to-br from-slate-900 via-[#182338] to-[#0f172a] text-white p-5 shadow-lg animate-slide-up">
          ...
          {/* 目标推进概览 */}
          <Panel
            className="hover-lift animate-slide-up stagger-1"
            title={
              <div className="flex items-center gap-2">
          ...
          {/* 习惯打卡上下文 */}
          <Panel
            className="hover-lift animate-slide-up stagger-2"
            title={
              <div className="flex items-center gap-2">
          ...
          {/* 复盘引导小卡片 */}
          <div className="rounded-panel border border-warning/20 bg-warning-soft/50 p-4 hover-lift animate-slide-up stagger-3">
